...
GraphModelWrapper.prototype.downloadMetadata = function(charp) {
 return Asyncify.handleSleep(function(wakeUp) {
  ...
  loadJSON(model + "/metadata.json").then(function(json) {
...
GraphModelWrapper.prototype.predict = function(batches, inputBuffer, boardWxH, inputBufferChannels, inputGlobalBuffer, inputGlobalBufferChannels, values, miscvalues, ownerships, policies) {
 return Asyncify.handleSleep(function(wakeUp) {
  try {
...
if (Module["ENVIRONMENT_IS_PTHREAD"]) {
 const version = "2.8.2";
 importScripts(`//cdn.jsdelivr.net/npm/@tensorflow/tfjs@${version}/dist/tf.min.js`, `//cdn.jsdelivr.net/npm/@tensorflow/tfjs-backend-wasm@${version}/dist/tf-backend-wasm.min.js`);
...
var wasmBinaryFile = "katago.wasm";
...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var pthreadMainJs = locateFile("katago.worker.js");
...
var proxiedFunctionTable = [ null, _atexit, ___sys_fcntl64, ___sys_ioctl, ___sys_lstat64, ___sys_mkdir, ___sys_open, ___sys_readlink, ___sys_stat64, _emscripten_set_canvas_element_size_main_thread, _environ_get, _environ_sizes_get, _fd_close, _fd_read, _fd_seek, _fd_write, _tzset, _sysconf ];
...
var asmLibraryArg = {
 ...
 "downloadMetadata": _downloadMetadata,
 ...
 "jsGetModelVersion": _jsGetModelVersion,
...
var __emscripten_main_thread_futex = Module["__emscripten_main_thread_futex"] = 204816;
